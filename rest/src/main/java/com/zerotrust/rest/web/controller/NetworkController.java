...
// These are hacks around the issue with the repository and agentcounts.
    ...
    @RequestMapping(value = "/networks/search/count-active-destination-connections", method = RequestMethod.GET, produces = MediaTypes.HAL_JSON_VALUE)
    ...
    @PreAuthorize("hasAuthority('networks_read')")
    @RequestMapping(value = "/networks/search/count-active-source-connections", method = RequestMethod.GET, produces = MediaTypes.HAL_JSON_VALUE)
    ...
    @RequestMapping(value = "/networks", method = RequestMethod.POST, produces = MediaTypes.HAL_JSON_VALUE)
